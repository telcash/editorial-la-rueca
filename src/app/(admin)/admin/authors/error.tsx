...
export default function AdminAuthorsError({ unstable_retry }: { unstable_retry: () => void }) {
  return (
    <section className="rounded-lg border border-border bg-card px-6 py-10 text-center">
      ...
      <h1 className="mt-4 text-xl font-semibold text-foreground">
        No se pudo cargar el listado de autores
      </h1>
      <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground">
        Intenta recargar la pantalla. Si el problema continúa, revisa la conexión con la base de
        datos.
      </p>
